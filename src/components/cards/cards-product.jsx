        ...
        //  </div>
         <div className="container__products__products__banner">
             <div className="container__products__products__banner__header">
                 ...
                 <div className="container__products__products__banner__header-title">{price} $</div>
             </div>
             

             <div className="container__products__products__banner__button">

                 <button className="container__products__products__banner__button-create" onClick={editProduct}>
                 ...
                 <button className="container__products__products__banner__button-delete" onClick={removeProduct}>
